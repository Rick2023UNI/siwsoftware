...
public class SoftwareController {
	...
	public String getSoftware(@PathVariable("id") Long id, Model model) {
		...
		Recensione recensione = recensioneService.findBySoftwareAndUtente(software, utente); // cerca recensione dell
																								// utete corrente
		if (recensione == null) {
	...
	public String updateSoftware(@PathVariable("id") Long id, @ModelAttribute("software") Software softwareAggiornato,
			@RequestParam("fileImage") MultipartFile[] multipartFiles) throws IOException {
		Software software = this.softwareService.findById(id);

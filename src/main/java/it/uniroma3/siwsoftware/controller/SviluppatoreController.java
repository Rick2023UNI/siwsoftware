...
public class SviluppatoreController {
	...
	@Autowired
	SoftwareHouseService softwareHouseService;
	@Autowired
	...
	// action ti fa aprire sempre la stessa form sia per creare che per modificare e
	// in base ad action la form chiama la post a path diversi
	...
	public String formUpdateSviluppatore(Model model, @PathVariable("id") Long id) {
	...
	public String newSviluppatore(@Valid @ModelAttribute("utente") Utente utente,
			BindingResult credentialsBindingResult, @ModelAttribute("sviluppatore") Sviluppatore sviluppatore,
	...
	// form per aggiungere sviluppatori al software
	@GetMapping("/admin/formAddSviluppatoreSoftware/{idSoftware}")
	public String formAddSviluppatoreSoftware(@PathVariable("idSoftware") Long idSoftware, Model model) {
		...
		// La s è mancante per rendere possibile concatenare la s minuscola o maiuscola
		// a seconda del caso
	...
	public String addSviluppatoreSoftware(@PathVariable("idSoftware") Long idSoftware,
			@PathVariable("idSviluppatore") Long idSviluppatore, Model model) {
	...
	public String formAddSviluppatoreSoftwareHouse(@PathVariable("idSoftwareHouse") Long idSoftwareHouse, Model model) {
	...
	// Aggiungi sviluppatore a Software House
	...
	// Rimuovi sviluppatore da Software House
	...
	public String searchManage(@RequestParam("nome") String nome, @RequestParam("cognome") String cognome,
			Model model) {
		ArrayList<Sviluppatore> sviluppatori = this.sviluppatoreService.findByNomeContainingAndCognomeContaining(nome,
				cognome);
		model.addAttribute("sviluppatori", sviluppatori);
		return "admin/manageSviluppatori.html";
	}

	// tipologia è se usi form ricerca sopra o sotto, operazione è se apri la pagina
	// da software o software house
	...
	public String searchAddSviluppatore(@PathVariable("operazione") String operazione,
			@PathVariable("tipologiaRicerca") String tipologiaRicerca, @PathVariable("id") Long id,
			@RequestParam("nome") String nome, @RequestParam("cognome") String cognome, Model model) {
		...
		if (tipologiaRicerca.equals("software")) {
			...
			// Rimozione di tutti gli sviluppatori che già fanno parte del software/software
			// house
